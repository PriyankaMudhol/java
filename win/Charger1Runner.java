class Charger1Runner
{
 public static void main(String[] args)
 {
	...
	System.out.println("jean name:"+jean.name);
	System.out.println("jean price:"+jean.price);
	System.out.println("jean quantity:"+jean.quantity);
