...
class Hospital
{
	public static double price(String medicineName)
	{
		...
		if(medicineName=="Bcomplex")
		{
			System.out.println("Price of Bcomplex");
			return 212.56;
		}
		else if(medicineName=="Meftal spas")
		{
			System.out.println("price of Meftal spas");
			return 32.54;
		}
		else if(medicineName=="Cipla")
		{
			System.out.println("price of Cipla");
			return 421.43;
		}
